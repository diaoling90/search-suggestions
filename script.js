...
const translations = {
    ...
    en: {
        ...
        wordRootsPlaceholder: 'Enter word roots, one per line, such as:\nAI\nmachine learning\ndata science',
        fixedKeywords: 'Fixed Keywords (one per line)',
        fixedKeywordsHint: 'Complete search keywords to be used directly',
        fixedKeywordsPlaceholder: 'Enter fixed keywords, one per line, such as:\nartificial intelligence tools\nbest AI software 2024',
